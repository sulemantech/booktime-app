...
// BookCard component now uses the useRouter hook passed down as a prop
const BookCard = ({ item }) => {
    ...
    return (
        <TouchableOpacity
            ...
            onPress={() => router.push({
                pathname: 'StoryScreen', // This will need to be the actual pathname for the story screen
                params: {
