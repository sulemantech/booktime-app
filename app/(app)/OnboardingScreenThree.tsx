...
const OnboardingScreenThree = () => {
    ...
    const { childName: childNameFromParams, selectedAge: selectedAgeFromParams } = useLocalSearchParams();
    ...
    const handleContinue = () => {
        if (isButtonEnabled) {
            ...
            router.push({
                pathname: "OnboardingScreenFour",
                params: {
                    childName: childName,
                    selectedAge: selectedAge,
                    selectedInterests: selectedInterests.join(','), // Convert array to string
                },
            });
        }
    };
            ...
            <View style={[styles.container, { paddingBottom: insets.bottom + 20 }]}>
                ...
                <View style={styles.content}>
                    ...
                    <Text style={styles.subtitle}>
                        Choose up to 3 favorite topics to personalize your learning
                    </Text>
