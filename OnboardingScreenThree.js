...
const OnboardingScreenThree = ({ route, navigation }) => {
  ...
  const handleContinue = () => {
    // Navigate to the next screen and pass the selected interests.
    // For this example, we'll navigate to a 'Home' or 'Start' screen.
    navigation.navigate('Home', { childName, childAge, interests: selectedInterests });
  };
